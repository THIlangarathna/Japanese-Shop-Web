...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            <form method="POST" action="/Gohonzon" enctype="multipart/form-data">
                @csrf
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="form-group row d-flex justify-content-between">
                            ...
                            <div class="col-md-4">
                                <input id="address_permanent" type="text" class="form-control @error('address_permanent') is-invalid @enderror" name="address_permanent" value="{{ old('address_permanent') }}" required autocomplete="address_permanent">
                            ...
                            <div class="col-md-4">
                                <input id="address_current" type="text" class="form-control @error('address_current') is-invalid @enderror" name="address_current" value="{{ old('address_current') }}" autocomplete="address_current">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input id="e_name" type="text" class="form-control @error('e_name') is-invalid @enderror" name="e_name" value="{{ old('e_name') }}" autocomplete="e_name">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input id="e_date" type="date" class="form-control @error('e_date') is-invalid @enderror" name="e_date" value="{{ old('e_date') }}" autocomplete="e_date">
            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="form-group row d-flex justify-content-center">
                            ...
                            <div class="col-md-4">
                                <input id="s_contact_mobile" type="text" class="form-control @error('s_contact_mobile') is-invalid @enderror" name="s_contact_mobile" value="{{ old('s_contact_mobile') }}" autocomplete="s_contact_mobile">
